...
struct legacy_buffer_base : buffer_base {
  using base = buffer_base;

  /// Default Constructor Forwarded From Resource Base
  ///
  static auto create() noexcept -> legacy_buffer_base {
    return legacy_buffer_base{base::create()};
  }
...
///
///
STRICT_FINAL_USING(legacy_buffer, unique_resource<legacy_buffer_base>);
